...
export default {
  ...
  methods: {
    ...
    /**
     * Return the heading visibility for the specified attribute
     *
     * @param tab
     * @param attribute
     * @returns {boolean}
     */
    getHeadingVisibilityForAttribute(tab, attribute) {
      return tab.properties.headingVisibilityForRelationshipAttributes.includes(
        attribute
      )
    },
